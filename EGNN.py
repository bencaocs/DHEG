...
class EGNN(nn.Module):
    def __init__(
        ...
        self.edge_mlp = nn.Sequential(
            ...
            dropout,
            SiLU(),
            nn.Linear(edge_input_dim * 2, m_dim),  #edge_input_dim=126,m_dim=17
            SiLU()
        )
    ...
    def forward(self, feats, coors, edges = None, mask = None, adj_mat = None):
        ...
        edge_input = torch.cat((feats_i, feats_j, rel_dist), dim = -1)#源节点特征、目标节点特征、处理后的距离信息
