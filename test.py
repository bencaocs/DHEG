...
Model_Path = "/Log/2025-10-05-18-03-18 DE/model/"# FocalLoss(gamma=0.5, alpha=0.85) # Unbalance
...
def main():
    ...
    print("Evaluate DHEGPPIS on Test_60")
    test_one_dataset(Test_60, Test60_psepos_Path, 'Test_60')
    # exit()
    print("Evaluate DHEGPPIS on Test_315-28")
